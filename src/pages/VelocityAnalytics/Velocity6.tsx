  ...
  return (
    <SectionType2
      ...
      text={
        <>
          <p>
            Delayed insights kill momentum. Overbuilt analytics kill speed.
          </p>
          <p>
           Velocity Analytics™ gives you real-time clarity — so you can iterate faster, spend smarter, and grow with precision.
          </p>
        </>
      }
    />
